  ...
  @include('front.header')
    ...
    <section id="menu" style="height: 41rem;" class="menu section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" x-data="bowlcompose()" data-aos="fade-up" data-aos-delay="200" >
...
<!-- Bottom Navigation -->  
<div class="bottom-0 fixed left-0 right-0" x-show="step != 'complete'">
  <div class=" mx-auto px-4">
