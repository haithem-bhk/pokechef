...
<section id="dessert" class="menu section-bg">
  <div class="container" data-aos="fade-up">

    <div class="section-title">
      <h2>Our desserts</h2>
      <p>Check Our Tasty desserts</p>
    </div>
    ...
    <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="col-lg-6 menu-item filter-specialty">
        <img src="{{route('dessertImage', ['imageName' => $dessert->image_path ])}}" class="menu-img" alt="">
        <div class="menu-content">
          <a href="#" class="item-name" >{{$dessert->name}}</a><span class="item-price">€{{$dessert->price}}</span>
        </div>
        ...
        <button class="add-to-cart-button" @click="addToCart({{$dessert->id}},'dessert')">
