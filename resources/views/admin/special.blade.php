              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Add New Special</h4>
                  </div>
                  <form method="post" action="{{ route('newSpecial') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        ...
                        <input class="form-check-input" type="radio" name="visible" id="exampleRadios1" checked value="1">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <button class="btn btn-primary" type="submit">Add Plate</button>
                      </form>
                      </div>
                    </div>
                  </div>
