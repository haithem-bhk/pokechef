        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit {{$drink->name}}</h4>
            </div>
            <form method="post" action="{{ route('editDrink',['id' => $drink->id]) }}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="form-group row mb-4">
                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Title</label>
                  <div class="col-sm-12 col-md-7">
                    <input name="name" type="text" value="{{$drink->name}}" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <div id="image-preview" class="image-preview">
                      <img class="preview"   src="{{route('drinkImage', ['imageName' => $drink->image_path ])}}" id="img">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <textarea name="description"  class="summernote-simple">{{$drink->description}}</textarea>
                  </div>
                </div>
                <div class="form-group row mb-4">
                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Price</label>
                  <div class="col-sm-5 col-md-2">
                    <input type="text" name="price" class="form-control" value="{{$drink->price}}">
                  </div>
                </div>
                <div class="form-group row mb-4">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="visible" id="exampleRadios1" @if($drink->visible) checked @endif value="1">
                      <label class="form-check-label" for="exampleRadios1">
                        Yes
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="visible" id="exampleRadios2" @if(!$drink->visible) checked @endif value="0">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <button class="btn btn-primary" type="submit">Edit drink</button>
                  </form>
                </div>
              </div>
            </div>
